      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-orbitron text-2xl font-bold text-white mb-4">
              YAPPERTAR<span className="text-red-500">-ai</span>
            </h2>
            <p className="font-space-mono text-gray-300 mb-6 max-w-md">
              Мощный ИИ от команды GenAI. 17B модель на transformer архитектуре.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://t.me/fantominsight" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-red-500 transition-colors duration-200"
                aria-label="Telegram канал команды"
              >
                <Icon name="Send" size={20} />
              </a>
              <a 
                href="https://t.me/yappertar_ai_bot" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-red-500 transition-colors duration-200"
                aria-label="Telegram бот"
              >
                <Icon name="Bot" size={20} fallback="MessageSquare" />
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-red-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">2025 YAPPERTAR-ai by GenAI. Все права защищены.</p>
